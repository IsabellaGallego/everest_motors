...
CREATE TABLE clientes (
    ...
    cedula_cliente    INTEGER (50)  NOT NULL UNIQUE,
...
CREATE TABLE empleados (
    ...
    codigo_empleado           INTEGER(50) NOT NULL  UNIQUE,
    ...
    email_empresa_empleado    VARCHAR(50),
    id_tipo_usuario           INT   REFERENCES tipo_usuarios (id_tipo_usuario) 
);
...
CREATE TABLE envio_vehiculo (
    id_envio_transporte   INTEGER  PRIMARY KEY AUTO_INCREMENT
                                   NOT NULL,
...
CREATE TABLE facturad_compra (
    id_facturad_compra        INTEGER  PRIMARY KEY AUTO_INCREMENT UNIQUE NOT NULL,
    ...
    total_compra              DOUBLE,
    medio_pago_usado_compra   VARCHAR  (50) NOT NULL,
    id_cliente     INT       REFERENCES clientes (id_cliente),
    id_empleado    INT       REFERENCES empleados (id_empleado),
    id_envio_transporte   INT       REFERENCES envio_vehiculo (id_envio_transporte),
...
CREATE TABLE lista_facturasd_ventas (
    id_facturasd_ventas  INTEGER PRIMARY KEY AUTO_INCREMENT
                                 NOT NULL,
    valor_ventas_totales DOUBLE,
    id_facturad_compra      INT     REFERENCES facturad_compra (id_facturad_compra) 
);
...
CREATE TABLE proveedor (
    ...
    representante_proveedor VARCHAR(50),
...
CREATE TABLE solicitudes_pre_compras (
    id_solicitud_precompras           INTEGER  PRIMARY KEY AUTO_INCREMENT  NOT NULL,
    fecha_solicitud                   DATETIME NOT NULL,
    concesionario_nombre_solicitud    VARCHAR(50)  NOT NULL,
    concesionario_direccion_solicitud VARCHAR(50),
    ciudad_solicitud                  VARCHAR(50),
    pais_solicitud                    INT   NOT NULL,
    escriba_id_vehiculo_comprar       INTEGER  UNIQUE NOT NULL,
    id_cliente                        INT         REFERENCES clientes (id_cliente) 
);
...
CREATE TABLE tipo_usuarios (
    id_tipo_usuario INTEGER      PRIMARY KEY AUTO_INCREMENT  NOT NULL,
...
CREATE TABLE vehiculos (
    id_vehiculo                    INTEGER      PRIMARY KEY AUTO_INCREMENT NOT NULL UNIQUE,
